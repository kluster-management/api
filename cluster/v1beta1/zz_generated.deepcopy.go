...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in ClusterGroupsMap) DeepCopyInto(out *ClusterGroupsMap) {
	{
		in := &in
		*out = make(ClusterGroupsMap, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterGroupsMap.
func (in ClusterGroupsMap) DeepCopy() ClusterGroupsMap {
	if in == nil {
		return nil
	}
	out := new(ClusterGroupsMap)
	in.DeepCopyInto(out)
	return *out
}
